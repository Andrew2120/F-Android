...
data class BottomValuesContainer(
    val elevationBottom100: com.b_labs.fiber_tokens.BoxShadow = com.b_labs.fiber_tokens.BoxShadow(
        y = 1.0,
        x = 0.0,
        type = "dropShadow",
        spread = 0.0,
    ...
    val elevationBottom200: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = 2.0,
            x = 0.0,
            type = "dropShadow",
            spread = -1.0,
    ...
    val elevationBottom300: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = 2.0,
            x = 0.0,
            type = "dropShadow",
    ...
    val elevationBottom400: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = 2.0,
            x = 0.0,
            type = "dropShadow",
...
data class TopValuesContainer(
    val elevationTop100: com.b_labs.fiber_tokens.BoxShadow = com.b_labs.fiber_tokens.BoxShadow(
        y = -1.0,
        x = 0.0,
        type = "dropShadow",
        spread = 0.0,
    ...
    val elevationTop200: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = -2.0,
            x = 0.0,
            type = "dropShadow",
    ...
    val elevationTop300: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = -2.0,
            x = 0.0,
            type = "dropShadow",
    ...
    val elevationTop400: List<com.b_labs.fiber_tokens.BoxShadow> = listOf(
        com.b_labs.fiber_tokens.BoxShadow(
            y = -2.0,
            x = 0.0,
            type = "dropShadow",
...
data class ElevationValuesContainer(
    val bottom: com.b_labs.fiber_tokens.BottomValuesContainer = com.b_labs.fiber_tokens.BottomValuesContainer(),
    val top: com.b_labs.fiber_tokens.TopValuesContainer = com.b_labs.fiber_tokens.TopValuesContainer(),
)
...
val x = com.b_labs.fiber_tokens.ContentValuesContainer1(
...
data class ActionValuesContainer1(
    val primary: com.b_labs.fiber_tokens.PrimaryValuesContainer1 = com.b_labs.fiber_tokens.PrimaryValuesContainer1(),
    val neutral: com.b_labs.fiber_tokens.NeutralValuesContainer3 = com.b_labs.fiber_tokens.NeutralValuesContainer3(),
    val success: com.b_labs.fiber_tokens.SuccessValuesContainer2 = com.b_labs.fiber_tokens.SuccessValuesContainer2(),
    val danger: com.b_labs.fiber_tokens.DangerValuesContainer3 = com.b_labs.fiber_tokens.DangerValuesContainer3(),
    val ghost: com.b_labs.fiber_tokens.GhostValuesContainer2 = com.b_labs.fiber_tokens.GhostValuesContainer2(),
    val outline: com.b_labs.fiber_tokens.OutlineValuesContainer1 = com.b_labs.fiber_tokens.OutlineValuesContainer1(),
    val inverse: com.b_labs.fiber_tokens.InverseValuesContainer2 = com.b_labs.fiber_tokens.InverseValuesContainer2(),
    val reverseInverse: com.b_labs.fiber_tokens.ReverseInverseValuesContainer1 = com.b_labs.fiber_tokens.ReverseInverseValuesContainer1(),
)
...
data class InteractionValuesContainer1(
    val default: com.b_labs.fiber_tokens.DefaultValuesContainer1 = com.b_labs.fiber_tokens.DefaultValuesContainer1(),
    val neutral: com.b_labs.fiber_tokens.NeutralValuesContainer4 = com.b_labs.fiber_tokens.NeutralValuesContainer4(),
    val danger: com.b_labs.fiber_tokens.DangerValuesContainer4 = com.b_labs.fiber_tokens.DangerValuesContainer4(),
    val ghost: com.b_labs.fiber_tokens.GhostValuesContainer3 = com.b_labs.fiber_tokens.GhostValuesContainer3(),
    val disabled: com.b_labs.fiber_tokens.DisabledValuesContainer1 = com.b_labs.fiber_tokens.DisabledValuesContainer1(),
    val border: com.b_labs.fiber_tokens.BorderValuesContainer3 = com.b_labs.fiber_tokens.BorderValuesContainer3(),
    val background: com.b_labs.fiber_tokens.BackgroundValuesContainer3 = com.b_labs.fiber_tokens.BackgroundValuesContainer3(),
    val inverse: com.b_labs.fiber_tokens.InverseValuesContainer3 = com.b_labs.fiber_tokens.InverseValuesContainer3(),
    val focus: com.b_labs.fiber_tokens.FocusValuesContainer1 = com.b_labs.fiber_tokens.FocusValuesContainer1(),
)
