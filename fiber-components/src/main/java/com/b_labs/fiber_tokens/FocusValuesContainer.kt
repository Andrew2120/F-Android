...
data class InteractionValuesContainer(
    val default: com.b_labs.fiber_tokens.DefaultValuesContainer = com.b_labs.fiber_tokens.DefaultValuesContainer(),
    val neutral: com.b_labs.fiber_tokens.NeutralValuesContainer1 = com.b_labs.fiber_tokens.NeutralValuesContainer1(),
    val danger: com.b_labs.fiber_tokens.DangerValuesContainer1 = com.b_labs.fiber_tokens.DangerValuesContainer1(),
    val ghost: com.b_labs.fiber_tokens.GhostValuesContainer1 = com.b_labs.fiber_tokens.GhostValuesContainer1(),
    val disabled: com.b_labs.fiber_tokens.DisabledValuesContainer = com.b_labs.fiber_tokens.DisabledValuesContainer(),
    val border: com.b_labs.fiber_tokens.BorderValuesContainer1 = com.b_labs.fiber_tokens.BorderValuesContainer1(),
    val background: com.b_labs.fiber_tokens.BackgroundValuesContainer1 = com.b_labs.fiber_tokens.BackgroundValuesContainer1(),
    val inverse: com.b_labs.fiber_tokens.InverseValuesContainer1 = com.b_labs.fiber_tokens.InverseValuesContainer1(),
    val focus: com.b_labs.fiber_tokens.FocusValuesContainer = com.b_labs.fiber_tokens.FocusValuesContainer(),
)
...
data class NonSemanticValuesContainer(
    val gray: com.b_labs.fiber_tokens.GrayValuesContainer = com.b_labs.fiber_tokens.GrayValuesContainer(),
    val white: com.b_labs.fiber_tokens.WhiteValuesContainer = com.b_labs.fiber_tokens.WhiteValuesContainer(),
    val red: com.b_labs.fiber_tokens.RedValuesContainer = com.b_labs.fiber_tokens.RedValuesContainer(),
    val magenta: com.b_labs.fiber_tokens.MagentaValuesContainer = com.b_labs.fiber_tokens.MagentaValuesContainer(),
    val purple: com.b_labs.fiber_tokens.PurpleValuesContainer = com.b_labs.fiber_tokens.PurpleValuesContainer(),
    val violet: com.b_labs.fiber_tokens.VioletValuesContainer = com.b_labs.fiber_tokens.VioletValuesContainer(),
    val blue: com.b_labs.fiber_tokens.BlueValuesContainer = com.b_labs.fiber_tokens.BlueValuesContainer(),
    val cyan: com.b_labs.fiber_tokens.CyanValuesContainer = com.b_labs.fiber_tokens.CyanValuesContainer(),
    val teal: com.b_labs.fiber_tokens.TealValuesContainer = com.b_labs.fiber_tokens.TealValuesContainer(),
    val aquamarine: com.b_labs.fiber_tokens.AquamarineValuesContainer = com.b_labs.fiber_tokens.AquamarineValuesContainer(),
    val green: com.b_labs.fiber_tokens.GreenValuesContainer = com.b_labs.fiber_tokens.GreenValuesContainer(),
    val orange: com.b_labs.fiber_tokens.OrangeValuesContainer = com.b_labs.fiber_tokens.OrangeValuesContainer(),
)
...
data class SemanticValuesContainer(
    val brand: com.b_labs.fiber_tokens.BrandValuesContainer = com.b_labs.fiber_tokens.BrandValuesContainer(),
    val neutral: com.b_labs.fiber_tokens.NeutralValuesContainer2 = com.b_labs.fiber_tokens.NeutralValuesContainer2(),
    val neutralAlpha: com.b_labs.fiber_tokens.NeutralAlphaValuesContainer = com.b_labs.fiber_tokens.NeutralAlphaValuesContainer(),
    val info: com.b_labs.fiber_tokens.InfoValuesContainer = com.b_labs.fiber_tokens.InfoValuesContainer(),
    val success: com.b_labs.fiber_tokens.SuccessValuesContainer1 = com.b_labs.fiber_tokens.SuccessValuesContainer1(),
    val warning: com.b_labs.fiber_tokens.WarningValuesContainer = com.b_labs.fiber_tokens.WarningValuesContainer(),
    val danger: com.b_labs.fiber_tokens.DangerValuesContainer2 = com.b_labs.fiber_tokens.DangerValuesContainer2(),
)
...
data class ColorValuesContainer(
    val content: com.b_labs.fiber_tokens.ContentValuesContainer = com.b_labs.fiber_tokens.ContentValuesContainer(),
    val border: com.b_labs.fiber_tokens.BorderValuesContainer = com.b_labs.fiber_tokens.BorderValuesContainer(),
    val background: com.b_labs.fiber_tokens.BackgroundValuesContainer = com.b_labs.fiber_tokens.BackgroundValuesContainer(),
    val action: com.b_labs.fiber_tokens.ActionValuesContainer = com.b_labs.fiber_tokens.ActionValuesContainer(),
    val interaction: com.b_labs.fiber_tokens.InteractionValuesContainer = com.b_labs.fiber_tokens.InteractionValuesContainer(),
    val nonSemantic: com.b_labs.fiber_tokens.NonSemanticValuesContainer = com.b_labs.fiber_tokens.NonSemanticValuesContainer(),
    val semantic: com.b_labs.fiber_tokens.SemanticValuesContainer = com.b_labs.fiber_tokens.SemanticValuesContainer(),
    val coolGray: com.b_labs.fiber_tokens.CoolGrayValuesContainer = com.b_labs.fiber_tokens.CoolGrayValuesContainer(),
    val coolGrayAlpha: com.b_labs.fiber_tokens.CoolGrayAlphaValuesContainer = com.b_labs.fiber_tokens.CoolGrayAlphaValuesContainer(),
    val neutralGray: com.b_labs.fiber_tokens.NeutralGrayValuesContainer = com.b_labs.fiber_tokens.NeutralGrayValuesContainer(),
    val neutralGrayAlpha: com.b_labs.fiber_tokens.NeutralGrayAlphaValuesContainer = com.b_labs.fiber_tokens.NeutralGrayAlphaValuesContainer(),
    val warmGray: com.b_labs.fiber_tokens.WarmGrayValuesContainer = com.b_labs.fiber_tokens.WarmGrayValuesContainer(),
    val warmGrayAlpha: com.b_labs.fiber_tokens.WarmGrayAlphaValuesContainer = com.b_labs.fiber_tokens.WarmGrayAlphaValuesContainer(),
    val whiteAlpha: com.b_labs.fiber_tokens.WhiteAlphaValuesContainer = com.b_labs.fiber_tokens.WhiteAlphaValuesContainer(),
    val red: com.b_labs.fiber_tokens.RedValuesContainer1 = com.b_labs.fiber_tokens.RedValuesContainer1(),
    val magenta: com.b_labs.fiber_tokens.MagentaValuesContainer1 = com.b_labs.fiber_tokens.MagentaValuesContainer1(),
    val purple: com.b_labs.fiber_tokens.PurpleValuesContainer1 = com.b_labs.fiber_tokens.PurpleValuesContainer1(),
    val violet: com.b_labs.fiber_tokens.VioletValuesContainer1 = com.b_labs.fiber_tokens.VioletValuesContainer1(),
    val blue: com.b_labs.fiber_tokens.BlueValuesContainer1 = com.b_labs.fiber_tokens.BlueValuesContainer1(),
    val cyan: com.b_labs.fiber_tokens.CyanValuesContainer1 = com.b_labs.fiber_tokens.CyanValuesContainer1(),
    val teal: com.b_labs.fiber_tokens.TealValuesContainer1 = com.b_labs.fiber_tokens.TealValuesContainer1(),
    val aquamarine: com.b_labs.fiber_tokens.AquamarineValuesContainer1 = com.b_labs.fiber_tokens.AquamarineValuesContainer1(),
    val green: com.b_labs.fiber_tokens.GreenValuesContainer1 = com.b_labs.fiber_tokens.GreenValuesContainer1(),
    val orange: com.b_labs.fiber_tokens.OrangeValuesContainer1 = com.b_labs.fiber_tokens.OrangeValuesContainer1(),
    val transparent: com.b_labs.fiber_tokens.TransparentValuesContainer = com.b_labs.fiber_tokens.TransparentValuesContainer(),
)
